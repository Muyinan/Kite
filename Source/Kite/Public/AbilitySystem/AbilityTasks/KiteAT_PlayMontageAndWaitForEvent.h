...
#include "KiteAT_PlayMontageAndWaitForEvent.generated.h"

class UKiteAbilitySystemComponent;

/** Delegate type used, EventTag and Payload may be empty if it came from the montage callbacks */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FKitePlayMontageAndWaitForEventDelegate, FGameplayTag, EventTag, FGameplayEventData, EventData);
 ...
 */
UCLASS()
class KITE_API UKiteAT_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
	
public:
	// Constructor and overrides
	UKiteAT_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	FKitePlayMontageAndWaitForEventDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
	FKitePlayMontageAndWaitForEventDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
	FKitePlayMontageAndWaitForEventDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
	FKitePlayMontageAndWaitForEventDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
	FKitePlayMontageAndWaitForEventDelegate EventReceived;
	...
	static UKiteAT_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
...
private:
	...
	UKiteAbilitySystemComponent* GetTargetASC();
