...
#include UE_INLINE_GENERATED_CPP_BY_NAME(KiteExperienceDefinition)

#define LOCTEXT_NAMESPACE "KiteSystem"

UKiteExperienceDefinition::UKiteExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UKiteExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UKiteExperienceDefinition::UpdateAssetBundleData()
{
