...
#include "KiteAbilityTagRelationshipMapping.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FKiteAbilityTagRelationship
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class KITE_API UKiteAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FKiteAbilityTagRelationship> AbilityTagRelationships;
};
